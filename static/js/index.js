function select_q_c_name(val){

        var data      = val.split('/');
        var m_no      = data[0]; // 主件品號
        var m_license = data[1]; // 序號
        var e_no      = data[2]; // 元件品號
        var p_amount  = data[3]; // 組成用量
        var e_name    = data[4]; // 元件品名

        var e_b_name_id  = '#' + m_license.trim() + '_' + e_no.trim();
        var e_b_name_val = $(e_b_name_id).val();
        
        
        if(e_b_name_val.length == 0){

                $('#click_show_msg').click();
                $('#show_msg').show(1000).html('<i class="bi bi-x-circle text-danger"></i> BOM 維護 - <span class="text-success">元件品名 : ' + e_name + '</span> , 修改量不能空白 !');
                exit();

        }
        else if(isNaN(e_b_name_val)){

                $('#click_show_msg').click();
                $('#show_msg').show(1000).html('<i class="bi bi-x-circle text-danger"></i> BOM 維護 - <span class="text-success">元件品名 : ' + e_name + '</span> , 修改量只能是數字 !');
                exit();

        }else{
                var f_name_val  = Math.floor(e_b_name_val * 1000) / 1000;
                
                $.ajax({
                        type:"POST",
                        url:"/update_erp_bom_data",
                        data:{
                              'm_no':m_no,
                              'm_license':m_license,
                              'e_no':e_no,
                        ...
                        beforeSend:function(){
                                $('#status').html('主件品號 ' + m_no  + ' , 序號 ' + m_license + ' , 元件品號' + e_no + ' , 組成用量 ' + p_amount).css({'color':'red'});
                        },
                        complete:function(){
...
function hr_360_download_excel(val){
        ...
        $.ajax({
                ...
                success:function(res){
                        ...
                        if (item == 'excel'){
                                var url = "/download_hr_360_excel?job="+job;
                                var fileName = 'hr_360_' + job + '.xlsx';
                ...
                beforeSend:function(){
                        $('#status').html("Download HR 360 - " + job + " 紀錄資料 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function reload_hr_360_person_member_list(){

        $.ajax({
                type:"POST",
                url:"/reload_hr_360_person_member_list",
                data:{
                ...
                success:function(res){
                         ...
                         * 
                         **************/ 
                        $('#hr_360_person_list').show(1000).html(res);
                ...
                beforeSend:function(){
                        $('#status').html("重新載入 HR 360 考評人員清單 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function reload_hr_360_person_list(){

        $.ajax({
                type:"POST",
                url:"/reload_hr_360_person_list",
                data:{
...
function submit_hr_360_member(){
        
        // 受評日期
        var hr_360_date       = $.trim($("#check_hr_360_date").text());           
        var check_hr_360_date = hr_360_date.split(":")[1] ? hr_360_date.split(":")[1].trim() : "";

        // 考評人員
        var hr_360_user       = $.trim($("#check_hr_360_user").text());           
        var check_hr_360_user = hr_360_user.split(":")[1] ? hr_360_user.split(":")[1].trim() : "";

        // 受評等級
        var hr_360_lv         = $.trim($("#check_hr_360_lv").text());           
        var check_hr_360_lv   = hr_360_lv.split(":")[1] ? hr_360_lv.split(":")[1].trim() : "";

        // 受評人員
        var hr_360_name       = $.trim($("#check_hr_360_name").text());           
        var check_hr_360_name = hr_360_name.split(":")[1] ? hr_360_name.split(":")[1].trim() : "";
        ...
        var total_1_avg      = ((hr_360_total_1_1 + hr_360_total_1_2 + hr_360_total_1_3 + hr_360_total_1_4 + hr_360_total_1_5)/5).toFixed(2); 
        ...
        var total_2          = hr_360_total_2_1 + hr_360_total_2_2 + hr_360_total_2_3 + hr_360_total_2_4 + hr_360_total_2_5; 
        var total_2_avg      = ((hr_360_total_2_1 + hr_360_total_2_2 + hr_360_total_2_3 + hr_360_total_2_4 + hr_360_total_2_5)/5).toFixed(2); 
        ...
        var total_3_avg      = ((hr_360_total_3_1 + hr_360_total_3_2 + hr_360_total_3_3 + hr_360_total_3_4 + hr_360_total_3_5)/5).toFixed(2); 
        ...
        var hr_360_total_4_5 = parseInt($('input[name="options4_5"]:checked').val(), 10) || 0;
        var total_4          = hr_360_total_4_1 + hr_360_total_4_2 + hr_360_total_4_3 + hr_360_total_4_4 + hr_360_total_4_5; 
        var total_4_avg      = ((hr_360_total_4_1 + hr_360_total_4_2 + hr_360_total_4_3 + hr_360_total_4_4 + hr_360_total_4_5)/5).toFixed(2); 
        ...
        var hr_360_total_5_4 = parseInt($('input[name="options5_4"]:checked').val(), 10) || 0;
        var hr_360_total_5_5 = parseInt($('input[name="options5_5"]:checked').val(), 10) || 0;
        var hr_360_total_5_6 = parseInt($('input[name="options5_6"]:checked').val(), 10) || 0;
        var total_5          = hr_360_total_5_1 + hr_360_total_5_2 + hr_360_total_5_3 + hr_360_total_5_4 + hr_360_total_5_5 + hr_360_total_5_6; 
        var total_5_avg      = ((hr_360_total_5_1 + hr_360_total_5_2 + hr_360_total_5_3 + hr_360_total_5_4 + hr_360_total_5_5 + hr_360_total_5_6)/6).toFixed(2); 
        
        // 對於客戶的服務(包含內部客戶或外部客戶)
        if($('input[name="options1_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 對於客戶的服務(包含內部客戶或外部客戶) 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 對於客戶的服務(包含內部客戶或外部客戶) 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 對於客戶的服務(包含內部客戶或外部客戶) 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 對於客戶的服務(包含內部客戶或外部客戶) 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 對於客戶的服務(包含內部客戶或外部客戶) 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 溝通與待人接物能力
        else if($('input[name="options2_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 溝通與待人接物能力 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 溝通與待人接物能力 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 溝通與待人接物能力 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 溝通與待人接物能力 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 溝通與待人接物能力 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 工作品質
        else if($('input[name="options3_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 工作品質 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 工作品質 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 工作品質 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 工作品質 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 工作品質 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 判斷力和決策能力
        else if($('input[name="options4_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 判斷力和決策能力 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 判斷力和決策能力 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 判斷力和決策能力 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 判斷力和決策能力 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 判斷力和決策能力 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 其他能力
        else if($('input[name="options5_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 5 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_6"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 其他能力 第 6 項, 不能不選 ! </span>');
                exit();
        }else{
                $.ajax({
                        type:"POST",
                        url:"/submit_hr_360_content_data_member",
                        data:{
                                'check_hr_360_date':check_hr_360_date,
                                'check_hr_360_user':check_hr_360_user,
                                'check_hr_360_lv':check_hr_360_lv,
                                'check_hr_360_name':check_hr_360_name,
                                'hr_360_total_1_1':hr_360_total_1_1,
                                'hr_360_total_1_2':hr_360_total_1_2,
                                'hr_360_total_1_3':hr_360_total_1_3,
                                'hr_360_total_1_4':hr_360_total_1_4,
                                'hr_360_total_1_5':hr_360_total_1_5,
                                'hr_360_total_2_1':hr_360_total_2_1,
                                'hr_360_total_2_2':hr_360_total_2_2,
                                'hr_360_total_2_3':hr_360_total_2_3,
                                'hr_360_total_2_4':hr_360_total_2_4,
                                'hr_360_total_2_5':hr_360_total_2_5,
                                'hr_360_total_3_1':hr_360_total_3_1,
                                'hr_360_total_3_2':hr_360_total_3_2,
                                'hr_360_total_3_3':hr_360_total_3_3,
                                'hr_360_total_3_4':hr_360_total_3_4,
                                'hr_360_total_3_5':hr_360_total_3_5,
                                'hr_360_total_4_1':hr_360_total_4_1,
                                'hr_360_total_4_2':hr_360_total_4_2,
                                'hr_360_total_4_3':hr_360_total_4_3,
                                'hr_360_total_4_4':hr_360_total_4_4,
                                'hr_360_total_4_5':hr_360_total_4_5,
                                'hr_360_total_5_1':hr_360_total_5_1,
                                'hr_360_total_5_2':hr_360_total_5_2,
                                'hr_360_total_5_3':hr_360_total_5_3,
                                'hr_360_total_5_4':hr_360_total_5_4,
                                'hr_360_total_5_5':hr_360_total_5_5,
                                'hr_360_total_5_6':hr_360_total_5_6,
                                'total_1':total_1,
                                'total_1_avg':total_1_avg,
                                'total_2':total_2,
                                'total_2_avg':total_2_avg,
                                'total_3':total_3,
                                'total_3_avg':total_3_avg,
                                'total_4':total_4,
                                'total_4_avg':total_4_avg,
                                'total_5':total_5,
                                'total_5_avg':total_5_avg
                        },
                        dataType:"html",
                        error:function(xhr , ajaxError , throwError){
                                $('#click_show_msg').click();
                        ...
                        beforeSend:function(){
                                $('#status').html("送出 HR 360 考評人員 " + check_hr_360_name + " , 項目內容資料 ...").css({'color':'red'});
                        },
                        complete:function(){
                                $('#status').css({'color':'#f8f9fa'});
                        }
...
function submit_hr_360_manager(){
        ...
        var total_2_avg      = ((hr_360_total_2_1 + hr_360_total_2_2 + hr_360_total_2_3 + hr_360_total_2_4 + hr_360_total_2_5 + hr_360_total_2_6)/6).toFixed(2); 
        ...
        var total_4_avg      = ((hr_360_total_4_1 + hr_360_total_4_2 + hr_360_total_4_3 + hr_360_total_4_4)/4).toFixed(2); 
        ...
        var total_5_avg      = ((hr_360_total_5_1 + hr_360_total_5_2 + hr_360_total_5_3)/3).toFixed(2); 
        ...
        var total_6_avg      = ((hr_360_total_6_1 + hr_360_total_6_2 + hr_360_total_6_3 + hr_360_total_6_4 + hr_360_total_6_5)/5).toFixed(2); 

        
        // 管理能力
        if($('input[name="options1_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 管理能力 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 管理能力 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 管理能力 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 管理能力 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options1_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 管理能力 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 提供支援
        else if($('input[name="options2_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 5 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options2_6"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 提供支援 第 6 項, 不能不選 ! </span>');
                exit();
        }
        // 以身作則
        else if($('input[name="options3_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 以身作則 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 以身作則 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 以身作則 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 以身作則 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options3_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 以身作則 第 5 項, 不能不選 ! </span>');
                exit();
        }
        // 效率導向
        else if($('input[name="options4_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 效率導向 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 效率導向 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 效率導向 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options4_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 效率導向 第 4 項, 不能不選 ! </span>');
                exit();
        }
        // 培育人才
        else if($('input[name="options5_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 培育人才 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 培育人才 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options5_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 培育人才 第 3 項, 不能不選 ! </span>');
                exit();
        }
        // 高效溝通
        else if($('input[name="options6_1"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 高效溝通 第 1 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options6_2"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 高效溝通 第 2 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options6_3"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 高效溝通 第 3 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options6_4"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 高效溝通 第 4 項, 不能不選 ! </span>');
                exit();
        }
        else if($('input[name="options6_5"]:checked').length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 考評 , 受評人員 ' + check_hr_360_name + ' , 高效溝通 第 5 項, 不能不選 ! </span>');
                exit();
        }else{
                $.ajax({
                        type:"POST",
                        url:"/submit_hr_360_content_data",
                        data:{
                                'check_hr_360_date':check_hr_360_date,
                                'check_hr_360_user':check_hr_360_user,
                                'check_hr_360_lv':check_hr_360_lv,
                                ...
                                'hr_360_total_2_4':hr_360_total_2_4,
                                'hr_360_total_2_5':hr_360_total_2_5,
                                'hr_360_total_2_6':hr_360_total_2_6,
                                'hr_360_total_3_1':hr_360_total_3_1,
                                'hr_360_total_3_2':hr_360_total_3_2,
                                'hr_360_total_3_3':hr_360_total_3_3,
                                'hr_360_total_3_4':hr_360_total_3_4,
                                ...
                                'hr_360_total_5_2':hr_360_total_5_2,
                                'hr_360_total_5_3':hr_360_total_5_3,
                                'hr_360_total_6_1':hr_360_total_6_1,
                                'hr_360_total_6_2':hr_360_total_6_2,
                                'hr_360_total_6_3':hr_360_total_6_3,
                                'hr_360_total_6_4':hr_360_total_6_4,
                                'hr_360_total_6_5':hr_360_total_6_5,
                                'total_1':total_1,
                                'total_1_avg':total_1_avg,
                                'total_2':total_2,
                                'total_2_avg':total_2_avg,
...
function select_hr_360_content_member(id){

        var hr_360_content_name = id;

        $.ajax({
                type:"POST",
                url:"/hr_360_content_name_member",
                data:{
...
function select_hr_name_data_5_5(){

        var res_hr_360_name = $.trim($("#res_hr_360_name_5_5").val());   
        $("#hr_360_check_subordinate_2_name_5_5").val(res_hr_360_name); 
...
function select_hr_name_data_5(){
   ...
   function keyin_hr_name_5_5(){
         
        // 平行 1 姓名 
        var h_360_hr_name = $.trim($("#hr_360_check_subordinate_2_name_5_5").val());  
  
        $.ajax({
          type:"POST",
          url:"/hr_360_employee_hr_name_5_5",
          data:{
          ...
          success:function(res){
                   ...
                   * 
                   **************/ 
                  $('#show_hr_360_name_data_5_5').show(1000).html(res);
...
function select_hr_name_data_4_4(){

        var res_hr_360_name = $.trim($("#res_hr_360_name_4_4").val());   
        $("#hr_360_check_subordinate_1_name_4_4").val(res_hr_360_name); 
...
function select_hr_name_data_4(){
   ...
   function keyin_hr_name_4_4(){
         
        // 平行 1 姓名 
        var h_360_hr_name = $.trim($("#hr_360_check_subordinate_1_name_4_4").val());  
  
        $.ajax({
          type:"POST",
          url:"/hr_360_employee_hr_name_4_4",
          data:{
                  'h_360_hr_name':h_360_hr_name
          },
          dataType:"html",
          ...
          success:function(res){
                   ...
                   * 
                   **************/ 
                  $('#show_hr_360_name_data_4_4').show(1000).html(res);
...
function select_hr_name_data_3_3(){

        var res_hr_360_name = $.trim($("#res_hr_360_name_3_3").val());   
        $("#hr_360_check_peer_2_name_3_3").val(res_hr_360_name); 
}
...
function select_hr_name_data_3(){
   ...
   function keyin_hr_name_3_3(){
         
        // 平行 1 姓名 
        var h_360_hr_name = $.trim($("#hr_360_check_peer_2_name_3_3").val());  
  
        $.ajax({
          type:"POST",
          url:"/hr_360_employee_hr_name_3_3",
          data:{
                  'h_360_hr_name':h_360_hr_name
          },
          dataType:"html",
          ...
          success:function(res){
                   ...
                   * 
                   **************/ 
                  $('#show_hr_360_name_data_3_3').show(1000).html(res);

                  $('#hr_360_check_peer_2_name_3_3').attr('data-bs-content', 'searching ...').popover({
                       trigger: 'hover',
                       placement: 'top'
                       });
...
function select_hr_name_data_2_2(){

        var res_hr_360_name = $.trim($("#res_hr_360_name_2_2").val());   
        $("#hr_360_check_peer_1_name_2_2").val(res_hr_360_name); 
...
function keyin_hr_name_2_2(){
         
        // 平行 1 姓名 
        var h_360_hr_name = $.trim($("#hr_360_check_peer_1_name_2_2").val());  
  
        $.ajax({
          type:"POST",
          url:"/hr_360_employee_hr_name_2_2",
          data:{
                  'h_360_hr_name':h_360_hr_name
          },
          dataType:"html",
          ...
          success:function(res){
                   ...
                   * 
                   **************/ 
                  $('#show_hr_360_name_data_2_2').show(1000).html(res);
                  
                  $('#hr_360_check_peer_1_name_2_2').attr('data-bs-content', 'searching ...').popover({
                       trigger: 'hover',
                       placement: 'top'
                       });
...
function select_hr_name_data_1_1(){

        var res_hr_360_name = $.trim($("#res_hr_360_name_1_1").val());   
        $("#hr_360_check_manager_name_1_1").val(res_hr_360_name); 
...
function keyin_hr_name_1_1(){
      
        // 姓名 
        var h_360_hr_name = $.trim($("#hr_360_check_manager_name_1_1").val());  
  
        $.ajax({
          type:"POST",
          url:"/hr_360_employee_hr_name_1_1",
          data:{
                  'h_360_hr_name':h_360_hr_name
          },
          dataType:"html",
          ...
          success:function(res){
                   ...
                   * 
                   **************/ 
                  $('#show_hr_360_name_data_1_1').show(1000).html(res);
                  
                  $('#hr_360_check_manager_name_1_1').attr('data-bs-content', 'searching ...').popover({
                  trigger: 'hover',
                  placement: 'top'
                  });
...
function alter_hr_360_setup_data2(id){
        ...
        $.ajax({
                type:"POST",
                url:"/alter_hr_360_manager_list2",
                data:{
                        'd_dep':d_dep,
                        'd_name':d_name
                },
                ...
                success:function(res){
                         ...
                         * 
                         **************/ 
                        $('#alter_hr_360_setup_data2').show(1000).html(res);
                ...
                beforeSend:function(){
                        $('#status').html("修改 HR 360 考評 " + d_dep + " / " + d_name  + " 人員資料 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function show_hr_360_person_result2_2_print(id){
        
        var s_name = id;

        $.ajax({
                type:"GET",
                url:"/show_hr_360_person_result2_2",
                data:{
                        's_name':s_name
                },
                dataType:"html",
                ...
                beforeSend:function(){
                        $('#status').html("載入 HR 360 考評 , 受評人員 : " + s_name  + " 人員資料 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function show_hr_360_person_result2_2(id){
...
function show_hr_360_person_result2(id){
        
        var s_name = id;

        $.ajax({
                type:"POST",
                url:"/show_hr_360_person_result2",
                data:{
                        's_name':s_name
                },
                dataType:"html",
...
function show_hr_360_person_result(id){
...
function show_hr_360_result(id){
        ...
        $.ajax({
                ...
                beforeSend:function(){
                        $('#status').html("載入 HR 360 考評 , 考評人員 : " + s_user + " , 受評人員 : " + s_name  + " 人員資料 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function del_hr_360_process_data(id){
        
        var data   = id.split('/');
        var s_user = data[0];
        var s_name = data[1];

        var check_del = prompt("<< 刪除  HR 360 考評資料 >> \n\n考評人員 : " + s_user + "\n\n受評人員 : " + s_name  + "\n\n已送出紀錄\n\n( 確定刪除 ,再按一次 y )\n\n ");
        
	if(check_del == 'y'){	        

                $.ajax({
                        type:"POST",
                        url:"/del_hr_360_manager_process_list",
                        data:{
                                's_user':s_user,
                                's_name':s_name
                        },
                        ...
                        beforeSend:function(){
                                $('#status').html("刪除 HR 360 考評 , 考評人員 : " + s_user + " , 受評人員 : " + s_name  + " 人員資料 ...").css({'color':'red'});
                        },
                        complete:function(){
                                $('#status').css({'color':'#f8f9fa'});
                        }
...
function del_hr_360_setup_data2(id){
        
        var data   = id.split('/');
        var d_dep  = data[0];
        var d_name = data[1];

        var check_del = prompt("<< 刪除  HR 360 考評 >> \n\n部門 : " + d_dep + "\n\n姓名 : " + d_name  + "\n\n( 確定刪除 , 再按一次 y )\n\n");
        
	if(check_del == 'y'){	        

                $.ajax({
                        type:"POST",
                        url:"/del_hr_360_manager_list2",
                        data:{
                                'd_dep':d_dep,
                                'd_name':d_name
                        },
...
function load_hr_360_manager_process_person_list2_2(){
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_manager_process_list2_2",
                data:{},
                dataType:"html",
                error:function(xhr , ajaxError , throwError){
                        $('#click_show_msg').click();
                ...
                beforeSend:function(){
                        $('#status').html("載入 HR 360 未考評人員資料 ...").css({'color':'red'});
                },
                complete:function(){
                        $('#status').css({'color':'#f8f9fa'});
                }
...
function load_hr_360_manager_process_person_list2(){
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_manager_process_list2",
                data:{},
                dataType:"html",
                error:function(xhr , ajaxError , throwError){
                        $('#click_show_msg').click();
...
function load_hr_360_manager_process_person_list2_3(){
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_manager_process_list2_3",
                data:{},
                dataType:"html",
                error:function(xhr , ajaxError , throwError){
                        $('#click_show_msg').click();
...
function load_hr_360_manager_process_person_list(){
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_manager_process_list",
                data:{},
                dataType:"html",
                error:function(xhr , ajaxError , throwError){
                        $('#click_show_msg').click();
...
function load_hr_360_manager_setup_person_list2(){
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_manager_list2",
                data:{},
                dataType:"html",
                error:function(xhr , ajaxError , throwError){
                        $('#click_show_msg').click();
...
function submit_hr_360_manager_setup_data_2(){
        
        // 部門  
        var h_360_m_dep2 = $.trim($("#hr_360_manager_dep2").val());
        // 姓名 
        var h_360_m_name2 = $.trim($("#hr_360_manager_name_2").val());
        // 等級
        var h_360_m_lv2   = $.trim($("#hr_360_check_name_lv_2").val());
        // 主管  
        var h_360_c_m_name2 = $.trim($("#hr_360_check_manager_name_1_1").val());
        // 平行 1  
        var h_360_c_p_1_name2 = $.trim($("#hr_360_check_peer_1_name_2_2").val());
        // 平行 2
        var h_360_c_p_2_name2 = $.trim($("#hr_360_check_peer_2_name_3_3").val());
        // 下屬 1
        var h_360_c_s_1_name2 = $.trim($("#hr_360_check_subordinate_1_name_4_4").val());
        // 下屬 2  
        var h_360_c_s_2_name2 = $.trim($("#hr_360_check_subordinate_2_name_5_5").val());


        // 部門
        if(h_360_m_dep2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 部門 , 不能空白 ! </span>');
                exit();
        }
        // 姓名
        else if(h_360_m_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 姓名 , 不能空白 ! </span>');
                exit();
        }
        // 主管姓名
        else if(h_360_c_m_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 主管姓名 , 不能空白 ! </span>');
                exit();
        }
        // 平行 1
        else if(h_360_c_p_1_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 平行姓名 1 , 不能空白 ! </span>');
                exit();
        }
        // 平行 2
        else if(h_360_c_p_2_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 平行姓名 2 , 不能空白 ! </span>');
                exit();
        }
        // 下屬 1
        else if(h_360_c_s_1_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 下屬姓名 1 , 不能空白 ! </span>');
                exit();
        }
        // 下屬 2
        else if(h_360_c_s_2_name2.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 員工考評 , 下屬姓名 2 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
                        type:"POST",
                        url:"/add_hr_360_setup_2",
                        data:{
                                'h_360_m_dep':h_360_m_dep2,
                                'h_360_m_name':h_360_m_name2,
                                'h_360_m_lv':h_360_m_lv2,
                                'h_360_c_m_name':h_360_c_m_name2,
                                'h_360_c_p_1_name':h_360_c_p_1_name2,
                                'h_360_c_p_2_name':h_360_c_p_2_name2,
                                'h_360_c_s_1_name':h_360_c_s_1_name2,
                                'h_360_c_s_2_name':h_360_c_s_2_name2
                        },
                        datatype:"html",
                        error:function(xhr , ajaxError , throwError){
                                $('#click_show_msg').click();
                        ...
                        success:function(res){
                                ...
                                // 部門  
                                $("#hr_360_manager_dep2").val("");
                                // 姓名 
                                $("#hr_360_manager_name_2").val("");
                                // 主管  
                                $("#hr_360_check_manager_name_1_1").val("");
                                // 平行 1  
                                $("#hr_360_check_peer_1_name_2_2").val("");
                                // 平行 2
                                $("#hr_360_check_peer_2_name_3_3").val("");
                                // 下屬 1
                                $("#hr_360_check_subordinate_1_name_4_4").val("");
                                // 下屬 2  
                                $("#hr_360_check_subordinate_2_name_5_5").val("");
...
function submit_hr_360_manager_setup_data(){
        ...
        // 等級
        var h_360_m_lv   = $.trim($("#hr_360_check_name_lv").val());
        // 主管  
        ...
        if(h_360_m_dep.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 部門 , 不能空白 ! </span>');
                exit();
        }
        // 姓名
        else if(h_360_m_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 姓名 , 不能空白 ! </span>');
                exit();
        }
        // 主管姓名
        else if(h_360_c_m_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 主管姓名 , 不能空白 ! </span>');
                exit();
        }
        // 平行 1
        else if(h_360_c_p_1_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 平行姓名 1 , 不能空白 ! </span>');
                exit();
        }
        // 平行 2
        else if(h_360_c_p_2_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 平行姓名 2 , 不能空白 ! </span>');
                exit();
        }
        // 下屬 1
        else if(h_360_c_s_1_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 下屬姓名 1 , 不能空白 ! </span>');
                exit();
        }
        // 下屬 2
        else if(h_360_c_s_2_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> HR 360 主管考評 , 下屬姓名 2 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
...
function select_dep_name2(){
        
        // 部門
        var h_3_m_dep = $.trim($("#hr_360_manager_dep2").val());
        
        $.ajax({
                type:"POST",
                url:"/load_hr_360_query_data_name2",
                data:{
                        'h_3_m_dep':h_3_m_dep
                },
                datatype:"html",
                ...
                success:function(res){
                        ...
                        // refresh show 
                        $('#load_hr_360_query_data_name2').show(1000).html(res);
...
function submit_erp_realtime_query_search3(){
        ...
        if(q_e_p_num3.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 原物料使用-原物料TO製品 , 產品品號 , 不能空白 ! </span>');
                exit();
        }
        // 產品批號
        else if(q_e_p_a_num3.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 原物料使用-原物料TO製品 , 產品批號 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
...
function submit_erp_realtime_query_search2(){
        ...
        if(q_e_p_i_y_month.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 製品庫存&生產實績 , 入庫年月 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
...
function submit_login_out_record_query_operation_search(){
        ...
        if(l_o_a_query.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> 帳號進出紀錄 , 帳號 , 不能空白 ! </span>');
                exit();
        }
        else{
                /**************
...
function submit_erp_realtime_query_search(){
        ...
        if(q_e_p_num.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 即時庫存查詢 , 產品品號 , 不能空白 ! </span>');
                exit();
        }
        // 產品名稱
        else if(q_e_p_name.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 即時庫存查詢 , 產品名稱 , 不能空白 ! </span>');
                exit();
        }
        // 產品批號
        else if(q_e_p_a_num.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i> ERP 即時庫存查詢 , 產品批號 , 不能空白 ! </span>');
                exit();
        }
        // 有效日期
        else if(q_e_p_l_date.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i>  ERP 即時庫存查詢 , 有效日期 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
...
function submit_bpm_expenditure_form_search(){
        ...
        if(q_s_date.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 , 起始日期 , 不能空白 ! </span>');
                exit();
        }
        // 結束日期
        else if(q_e_date.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 , 結束日期 , 不能空白 ! </span>');
                exit();
        }
        // 申請部門
        else if(q_b_e_dep.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 , 申請部門 , 不能空白 ! </span>');
                exit();
        }
        // 狀態
        else if(q_b_e_status.length == 0){
                show_msg('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 , 表單狀態 , 不能空白 ! </span>');
                exit();
        }
        else{
                $.ajax({
...
function submit_bpm_expenditure_form(){
        ...
        if(o_s_date == ""){
                $('#click_show_msg').click();
                $('#show_msg').show(1000).html('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 , 起始日期 , 不能空白 ! </span>');
                exit()
        }
        // 結束日期
        else if(o_e_date == ""){
                $('#click_show_msg').click();
                $('#show_msg').show(1000).html('<span><i class="bi bi-x-circle text-danger"></i>  BPM 開支證明單 ,  結束日期 , 不能空白 ! </span>');
                exit()
        }
...
function search_work_record_list(){

        var s_s_date    = $('#s_s_date').val();
        var s_e_date    = $('#s_e_date').val();
        var s_w_kind    = $('#s_w_kind').val();

        if(s_s_date.length == 0){
                exit();
        }else if(s_e_date.length == 0){
                exit();
        }else if(s_w_kind.length == 0){
                exit();
        }else{
                $.ajax({
                        type:"POST",
                        url:"/search_work_record_list",
                        data:{
                                's_s_date':s_s_date,  
                                's_e_date':s_e_date,  
                                's_w_kind':s_w_kind
...
function download_mrlibrary_file(val){
        
        const f_data = val;

        const url = "/download_mrlibrary_file?f_name="+f_data;
        const fileName = f_data;
...
function download_ai_rapid_miner_file(val){
        
        const ai_data = val;

        const url = "/download_ai_rapid_miner_file?f_name="+ai_data;
        const fileName = 'rapid_miner_' + ai_data;
...
function download_ai_fine_tuning_file(val){
        
        const ai_date = val;

        const url = "/download_ai_fine_tuning_file?ai_date="+ai_date;
        const fileName = 'ai_fine_tuning_' + ai_date + '.pptx';
...
function logout2(){
        ...
        $.ajax({
                ...
                success:function(res){
                        ...
                        alert("< Otsuka platform system message >\n\n超過10分鐘閒置 , 沒任何動作\n\n系統已將您自動登出 !\n\n再請重新登入。");
